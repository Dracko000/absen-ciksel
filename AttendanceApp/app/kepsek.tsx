  ...
  return (
    <ThemedView style={styles.container}>
      <ThemedView style={styles.header}>
        <ThemedText type="title" style={styles.title}>Dashboard Kepala Sekolah</ThemedText>
        {userInfo && (
      ...
      <ScrollView style={styles.content}>
        <ThemedView style={styles.qrSection}>
          ...
          <ThemedText style={styles.qrDescription}>
            QR Code untuk identifikasi Anda sebagai Kepala Sekolah
          </ThemedText>

          <View style={styles.qrContainer}>
            {userInfo && (
              <QRCode
                value={JSON.stringify({ id: userInfo.id, name: userInfo.name, type: 'kepsek', timestamp: Date.now() })}
                size={200}
                bgColor="white"
                fgColor="black"
              />
        ...
        <ThemedView style={styles.actionsSection}>
          <TouchableOpacity style={styles.optionButton} onPress={handleScanQR}>
            <ThemedText type="button" style={styles.optionButtonText}>Scan QR Code Guru</ThemedText>
          </TouchableOpacity>
